      ...
      <div className="w-full h-full lg:h-max flex pt-10 pb-10  items-center lg:pl-8 lg:pr-8 lg:justify-center">
        <div className="max-w-[650px] h-max lg:max-w-[500px] pl-16 lg:pl-0 pb-4 flex flex-col space-y-8">
          ...
          <div className="w-full flex space-x-4">
            <button className="max-w-[300px] w-full lg:max-w-full p-3 font-semibold bg-black border-2 border-white rounded-md text-white">
              {props.buttonText1}
            </button>
            {props.buttonText2 ? (
              <button className="max-w-[300px] lg:w-full w-full p-3 font-semibold bg-black border-2 border-white rounded-md text-white">
                {props.buttonText2}
              </button>
            ) : null}
          </div>
